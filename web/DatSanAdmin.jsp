                ...
                <div class="container py-2">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 col-md-6 col-lg-3">
                            <a href="loginhomeadmin" class="d-flex align-items-center site-logo">
                        ...
                        <div class="col-4 col-md-4 col-lg-8">
                            <nav class="site-navigation text-left" role="navigation">
                                ...
                                <ul class="site-menu js-clone-nav d-none d-lg-block">
                                    <li class="active">
                                        <a href="loginhomeadmin.jsp">Home</a>
                                    </li>
                    ...
                    <form class="form-horizontal" action="QLSB.jsp" >
                        ...
                        <div class="container">     
                            ...
                            <p class="col-lg-8 align-items-center justify-content-center text-center">
                                <a href="loginhomeadmin.jsp" class="btn btn-danger py-3 px-5 rounded-1">Hủy</a>
                                <a href="dktcadmin.jsp" class="btn btn-success btn-outline-white py-3 px-5 rounded-1">Xác nhận</a>
                                <%}%>
                            </p>
                        </div>  
