<%-- 
    Document   : QLTKDSan
    Created on : Jan 1, 2019, 8:55:27 AM
            ...
            <div class="site-navbar-wrap bg-white">
                ...
                <div class="unit-5 overlay" style="background-image: url('images/anh2.jpg');">
                    <div class="container text-center">
                        <h2 class="mb-0">Quản Lí Tài Khoản Khách Hàng </h2>
                        <p class="mb-0 unit-6"><a href="loginhomeadmin.jsp">Home</a> <span class="sep">></span> <span>Quản Lí Tài Khoản Khách Hàng</span></p>
                    </div>
                </div>
                ...
                <div class="py-5 bg-primary">
                    <div class="container">
                        ...
                        <p class="caption">Trang Quản Lí Tài Khoản Khách Hàng</p>
                ...
                <div class="thedentkkh">
                    <div class="timkiemKH">
                        ...
                        <input id="idtenKH" class="ten" placeholder="Tìm kiếm bằng Tên KH"></input>
                        <input id="iduser" class="ngay" placeholder="Tìm kiếm bằng UserName"></input>
                        <input id="idngay" class="gio" placeholder="Tìm kiếm bằng Ngày" ></input>
                ...
                <table class="tableshow" border="1" cellpadding="100" cellspacing="10">
                    ...
                    <tbody id="bangthongtin">
                        <% ShowTTKHDao d = new ShowTTKHDao();
                            for (ThongTinKhachHang k : d.getShowTTKH()) {
                        %>
