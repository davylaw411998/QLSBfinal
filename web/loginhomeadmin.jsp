<%-- 
    Document   : loginhomeadmin
    Created on : Jan 1, 2019, 8:34:43 AM
            ...
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-left" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li><a href="QLDSDatSan.jsp">Danh sách đặt sân</a></li>
                  <li><a href="QLTKKH.jsp">Danh sách tài khoản</a></li>
        ...
        <div class="container datsan">
          <div class="row">
            ...
            <div class="col-lg-7 site-section">
              ...
              <form class="form-horizontal" action="DatSanAdmin.jsp">
